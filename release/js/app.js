(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__body")) new core(".slider-main__body", {
            ...
            navigation: {
                prevEl: ".slider-main__body .button-prev",
                nextEl: ".slider-main__body .button-next"
            },
            on: {}
        });
        if (document.querySelector(".slider-rooms__body")) new core(".slider-rooms__body", {
            ...
            navigation: {
                prevEl: ".slider-rooms__body .button-prev",
                nextEl: ".slider-rooms__body .button-next"
            },
            on: {}
        });
        if (document.querySelector(".slider-tips__body")) new core(".slider-tips__body", {
            ...
            navigation: {
                prevEl: ".slider-tips__body .button-prev",
                nextEl: ".slider-tips__body .button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("action-product__button")) document.querySelector(".cart-header").classList.remove("_active");
        ...
        function loadProducts(data) {
            ...
            data.forEach((item => {
                ...
                let saleType = "";
                let itemFirstPart = ``;
                if (productLabels) productLabels.forEach((label => {
                    if ("new" === label.type) {
